...
use raydium_amm_v3::states::TickArrayBitmapExtension;
...
pub struct RoutePathItem {
  ...
  pub input_mint_pools: Vec<PoolBaseInfo>,

  /// 所有 output mint 和 route mint 的 pool
  pub output_mint_pools: Vec<PoolBaseInfo>,
...
pub struct AllRoutePathInfo {
  /// 直接路径
  pub direct_path: Vec<PoolBaseInfo>,
