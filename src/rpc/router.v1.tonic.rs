...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/router.v1.RouterService/QuotePrice",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("router.v1.RouterService", "QuotePrice"));
...
*/
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/router.v1.RouterService/CreateSwapTransaction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("router.v1.RouterService", "CreateSwapTransaction"),
                );
            self.inner.unary(req, path, codec).await
        }
        /** 获取仓位信息
*/
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/router.v1.RouterService/ListLinePosition",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("router.v1.RouterService", "ListLinePosition"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/router.v1.RouterService/ListLinePosition" => {
                    #[allow(non_camel_case_types)]
                    struct ListLinePositionSvc<T: RouterService>(pub Arc<T>);
                    impl<
                        T: RouterService,
                    ...
                    for ListLinePositionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RouterService>::list_line_position(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: RouterService> tonic::server::NamedService for RouterServiceServer<T> {
        const NAME: &'static str = "router.v1.RouterService";
    }
}
