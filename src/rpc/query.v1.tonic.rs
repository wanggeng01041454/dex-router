...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/query.v1.QueryService/CheckTx",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("query.v1.QueryService", "CheckTx"));
...
*/
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/query.v1.QueryService/GetContractInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("query.v1.QueryService", "GetContractInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
    ...
    impl<T: QueryService> tonic::server::NamedService for QueryServiceServer<T> {
        const NAME: &'static str = "query.v1.QueryService";
    }
}
